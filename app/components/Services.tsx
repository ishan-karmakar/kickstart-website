...
export default function Services() {
    return <div id="services" className="bg-gray-100 py-12" >
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                    ...
                    <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                        <div className="m-2 text-justify text-sm">
                            ...
                            <p className="text-md font-medium">
                                Custom-designed websites tailored to your brand, including service pages, contact forms, image galleries, and mobile-friendly layouts.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                        <div className="m-2 text-justify text-sm">
                            ...
                            <h2 className="font-semibold my-4 text-2xl text-center">Social Media Setup & Optimization</h2>
                            <p className="text-md font-medium">
                                Profile creation and setup on platforms like Instagram, Facebook, and LinkedIn, plus basic content strategy and branding support.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                        <div className="m-2 text-justify text-sm">
                            ...
                            <h2 className="font-semibold my-4 text-2xl text-center ">Branding & Messaging</h2>
                            <p className="text-md font-medium">
                                Assistance with logo design, brand colors, mission statements, About pages, and consistent tone across digital platforms.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                        <div className="m-2 text-justify text-sm">
                            ...
                            <h2 className="font-semibold my-4 text-2xl text-center ">Digital Support & Training</h2>
                            <p className="text-md font-medium">
                                One-on-one guidance on managing websites and social media, ongoing updates, and digital literacy training for long-term success.
                            </p>
                        </div>
                    </div>
                </div>
